        ...
        function mostrarCuadroSalir() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    // Si el usuario elige salir al menú principal, redirige a la página principal
                    window.location.href = 'index.php';
                } else {
                    // Si el usuario elige volver a la pantalla anterior, utiliza la función history.back()
...
<div class="section" id="pista1">
    ...
    <button class="horario"><a href="horario.php">Horario</a></button>
    </div>
